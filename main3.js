...
document.addEventListener("DOMContentLoaded", function () {
    ...
    class UiManager {
        ...
        loadPlayerInfoUI(player) {
            if (player) {
                this._playerNameTag.innerHTML = "Name: " + player._name;
                this._playerScoreTag.innerHTML = "Score: " + player._score;
                this._playerLevelTag.innerHTML = "Level: " + player._level;
                this._playerExperienceTag.innerHTML = "Experience: " + player._experience;
                this._playerLivesTag.innerHTML = "Lives: " + player.lives;
        ...
        loadGameInfoUI(game){
            this._gameStrikeTag.innerHTML = "Strikes: " + game._strikeCount;
            this._gameTimerTag.innerHTML = "Timer: 0";
            this._gameStopWatchTag.innerHTML = "StopWatch: 0";
            this._gameDifficultyTag.innerHTML = "Difficulty: " + game._difficulty;
        ...
        updatePlayerLivesTag(lives) {
            this._playerLivesTag.innerHTML = "Lives: " + lives;
        ...
        onGameStart() {
           this.hideSelectDifficultyUI();
            ...
            this._questionTag.innerHTML = "Click Generate Button to start the game!";
        ...
        onGenerateQuestion(){
            ...
            this._playerAnswerInput.value = "";
            this._questionTag.innerHTML = "Generating Question...";
            this.showStopWatch();
        ...
        updateStopWatch(time) {
            this._gameStopWatchTag.innerHTML = "StopWatch: " + time;
        }
        updateTimer(time) {
            this._gameTimerTag.innerHTML = "Timer: " + time;
        }
        updateStrike(strike) {
            this._gameStrikeTag.innerHTML = "Strikes: " + strike;
        }
